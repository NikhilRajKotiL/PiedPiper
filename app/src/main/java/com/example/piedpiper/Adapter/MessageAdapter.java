package com.example.piedpiper.Adapter;
...
import com.example.piedpiper.R;
...
public class MessageAdapter extends RecyclerView.Adapter<MessageAdapter.ViewHolder> {
    ...
    public MessageAdapter(Context mContext, List<Chat> mChat,String imageurl,String secretKey) {
        this.mChat = mChat;
    ...
    public void onBindViewHolder(@NonNull @NotNull MessageAdapter.ViewHolder holder, int position) {
        ...
        try {
            msg = "Encrypted: "+chat.getMessage()+"\nDecrypted: "+AesEncryption.decrypt(chat.getMessage(),secretKey);
        } catch (Exception e) {
            e.printStackTrace();
        }
